...
本文主要讲述进程内共享调用神器[SharedCalls](https://github.com/wjames2000/go-zero/blob/master/core/syncx/sharedcalls.go)。  
...
高并发场景下，当某个热点key缓存失效后，多个请求会同时从数据库加载该资源，并保存到缓存，如果不做防范，可能会导致数据库被直接打死。针对这种场景，go-zero框架中已经提供了实现，具体可参看[sqlc](https://github.com/wjames2000/go-zero/blob/master/core/stores/sqlc/cachedsql.go)和[mongoc](https://github.com/wjames2000/go-zero/blob/master/core/stores/mongoc/cachedcollection.go)等实现代码。
